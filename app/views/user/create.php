...
<div class="max-w-4xl mx-auto bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 mt-12 mx-4 relative z-10 overflow-hidden">
  ...
  <div class="relative z-10 text-center border-b border-green-200/50 pb-8 mb-10">
    <div class="flex flex-col items-center space-y-4">
      ...
      <div class="text-center space-y-2">
        ...
        <div class="text-xl font-semibold text-green-700">Add a new member</div>
  ...
  <!-- Form -->
  <form action="<?=site_url('user/create');?>" method="post" class="space-y-6 bg-gradient-to-r from-slate-50/80 to-green-50/80 backdrop-blur-sm rounded-2xl border border-green-100/50 p-8 shadow-lg">
    <div class="space-y-4">
